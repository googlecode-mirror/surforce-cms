<?php
class Menus_ItemsController extends Zcms_Generic_Controller {
	...
	function modificarAction() {
		...
		if ($this->_request->isPost ()) {
			...
			if (true === $cleanData ['secureData']) {
				...
				$data = array ('item' => $clean ['item'], 'destino' => $clean ['destino'], 'posicion' => $clean ['posicion'], 'privado' => $clean ['privado'], 'estado' => $clean ['estado'] );
