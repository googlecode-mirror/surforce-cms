<?php
class Menus_MenusController extends Zcms_Generic_Controller {
	...
	function agregarAction() {
		...
		if ($this->_request->isPost ()) {
			...
			if (true === $cleanData ['secureData']) {
				...
				$data = array ('nombre' => $clean ['nombre'], 'titulo' => $clean ['titulo'], 'descripcion' => $clean ['descripcion'], 'posicion' => $clean ['posicion'], 'privado' => $clean ['privado'], 'estado' => $clean ['estado'] );
