...
--
-- Servidor: localhost
-- Tiempo de generación: 07-03-2008 a las 16:55:51
...
(6, 'Sin festejos, Fidel cumple aï¿½os', '<p><img width="298" height="255" align="right" title="Fidel Castro" alt="Fidel" src="http://www.elpais.com.uy/07/08/13/33742_298.JPG" />La Habana.</p>', '2007-08-14 01:23:57', 0),
...
(6, 0, 'http://ewrwer', 'rewr', 'rwerwe'),
(3, 4, 'http://gmail.com', 'Gmail', 'Mail de Google');

-- --------------------------------------------------------

--
-- Table structure for table `styles_propiedades`
--
...
--
-- Dumping data for table `styles_propiedades`
--
...
--
-- Table structure for table `styles_propiedades_x_selectores`
--
...
--
-- Dumping data for table `styles_propiedades_x_selectores`
--
...
--
-- Table structure for table `styles_selectores`
--
...
--
-- Dumping data for table `styles_selectores`
--
...
(7, 'admin', 'admin', 'Admin', 'Admin', 'admin@surforce.com', 1, '2008-01-26 21:38:25', '2008-01-26 20:38:26');
...
(10, 'ABM Páginas', '/paginas/paginas/', 7, '1', '1'),
(11, 'ABM Usuarios', '/usuarios/usuarios/', 12, '1', '1'),
(14, 'ABM Menú Secciones', '/menus/menus/', 10, '1', '1'),
(15, 'Contacto', '/contacto/contacto/', 50, '0', '1'),
(18, 'ABM Configuracion General', '/admin/configuracion/', 600, '1', '1');
